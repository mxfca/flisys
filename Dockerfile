...
COPY docker_config/database/cert/mysql-client-key.pem /etc/ssl/mysql/
COPY docker_config/database/cert/mysql-client-cert.pem /etc/ssl/mysql/
COPY docker_config/database/cert/mysql-ca-cert.pem /etc/ssl/mysql/
